...
protected int yyleng = 0;                         // the length of yytext
  ...
  /**
 * int getLine() Description: Returns the line number of the line being analysed.
 * @uml.property  name="line"
 */
  public int getLine() {
	return line;
  ...
  /**
 * int getPos() Description: Returns the character position in the line being analysed.
 * @uml.property  name="pos"
 */
  public int getPos() {
	return pos;

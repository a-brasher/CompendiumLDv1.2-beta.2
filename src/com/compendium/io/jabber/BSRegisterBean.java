...
public class BSRegisterBean implements PacketListener {
    ...
    /**
	 * @uml.property  name="regListeners"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="com.compendium.io.jabber.BSRegListener"
	 */
    private Vector regListeners;
    /**
	 * @uml.property  name="servedTasks"
	 * @uml.associationEnd  qualifier="jidStr:java.lang.String com.compendium.io.jabber.BSRegState"
	 */

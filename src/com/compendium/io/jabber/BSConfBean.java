...
public class BSConfBean implements PacketListener, BSPresenceListener {
    ...
    /**
	 * @uml.property  name="bsMsgBean"
	 * @uml.associationEnd  
	 */
    protected BSMessengerBean bsMsgBean = null;
    /**
	 * @uml.property  name="iqBean"
	 * @uml.associationEnd  
	 */
    protected IQBean iqBean = null;
    /**
	 * @uml.property  name="presenceBean"
	 * @uml.associationEnd  
	 */
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" ordering="true" elementType="com.compendium.io.jabber.BSPresenceInfo" qualifier="toLowerCase:java.lang.String com.compendium.io.jabber.BSConfRoomInfo"
	 */
    protected Hashtable rooms = null;
    /**
	 * @uml.property  name="confListeners"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="com.compendium.io.jabber.BSConfListener"
	 */
    ...
    /**
	 * Sets existing and connected <code>BSPresenceBean</code>. Then this is registered as listener for presence events.
	 * @uml.property  name="presenceBean"
	 */

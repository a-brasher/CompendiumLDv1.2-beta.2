...
public class BSConnectionBean implements ConnectionListener, PacketListener {
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="org.jabber.jabberbeans.ConnectionListener"
	 */
    ...
    /**
	 * Returns current <code>ConnectionBean</code>. Which is typically used for initialization of other beans.
	 * @uml.property  name="connection"
	 */

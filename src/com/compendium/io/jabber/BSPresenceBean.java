...
public class BSPresenceBean implements PacketListener, ConnectionListener {
    /**
	 * @uml.property  name="curPresences"
	 * @uml.associationEnd  qualifier="str:java.lang.String com.compendium.io.jabber.BSPresencesOfJID"
	 */
    ...
    /**
	 * @uml.property  name="presenceListeners"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="com.compendium.io.jabber.BSPresenceListener"
	 */
    protected Vector presenceListeners;
    /**
	 * @uml.property  name="myJID"
	 * @uml.associationEnd  
	 */
    ...
    /**
	 * Sets existing and connected <code>ConnectionBean</code>. Then this is registered as listener for packet and connection events.
	 * @uml.property  name="connection"
	 */

...
public class BSRosterBean implements RosterListener, ConnectionListener {
    /**
	 * @uml.property  name="curRoster"
	 * @uml.associationEnd  multiplicity="(0 -1)" ordering="true" elementType="java.lang.String" qualifier="str:java.lang.String org.jabber.jabberbeans.RosterItem"
	 */
    private Hashtable curRoster;
    /**
	 * @uml.property  name="rosterBean"
	 * @uml.associationEnd  
	 */
    ...
    /**
	 * @uml.property  name="rosterListeners"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="org.jabber.jabberbeans.RosterListener"
	 */

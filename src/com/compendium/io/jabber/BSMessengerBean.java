...
public class BSMessengerBean implements PacketListener {
    ...
    /**
	 * @uml.property  name="unreadMsgs"
	 * @uml.associationEnd  multiplicity="(0 -1)" ordering="true" elementType="org.jabber.jabberbeans.Message" qualifier="str:java.lang.String java.util.Vector"
	 */
    private Hashtable unreadMsgs = null;
    /**
	 * @uml.property  name="msgTimeStamps"
	 * @uml.associationEnd  qualifier="msg:org.jabber.jabberbeans.Message java.util.Date"
	 */
    private Hashtable msgTimeStamps = null;
    /**
	 * @uml.property  name="msgListeners"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="com.compendium.io.jabber.BSMessageListener"
	 */
    private Vector msgListeners = null;
    /**
	 * @uml.property  name="blockedJIDs"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="org.jabber.jabberbeans.util.JID"
	 */
    private Vector blockedJIDs = null;
    /**
	 * @uml.property  name="blockGroupChat"
	 */
